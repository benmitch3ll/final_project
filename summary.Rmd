...
- The graph we made for showing where each regions countries lie in terms of their Happiness Rank. It has shown that some Regions have stronger range positioning than others. Western Europe generally has higher ranking countries, this could be because a high number of the Western European countries, such as Norway, Germany and Denmark, are considered as developed countries (external source 2).
